...
class VIOPipeline:
    ...
    def __init__(
        self, enable: bool = False, pos_std: float = 0.05, yaw_std: float = 0.03
    ):
        ...
        # Outlier filter
        self._pos_history = deque(maxlen=self.OUTLIER_WINDOW)  # type: ignore
